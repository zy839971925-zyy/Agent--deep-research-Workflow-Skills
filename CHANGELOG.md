...
- Replaced generic state items with typed semantic records.
- Separated declared state from computed effective state.
- Added typed references and a centralized edge policy.
- Added fixed-point transitive invalidation and cycle policies.
- Added machine-level epistemic closure and runtime closure gates.
- Added canonical-state ↔ delivery-manifest reconciliation.
- Added event continuity and raw-lineage validation.
