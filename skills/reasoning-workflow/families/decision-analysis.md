...
## References
- [`decision-and-recommendation`](../references/decision-and-recommendation.md) — Load only when the active gap matches one of: decision, recommendation, tradeoff, choice, allocation.
