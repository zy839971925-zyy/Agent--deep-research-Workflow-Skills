...
**Related:** [state model and invariants](state-model-and-invariants.md), [synchronization and recovery](synchronization-and-recovery.md), [change governance and effectiveness](change-governance-and-effectiveness.md), [formal review and audit](formal-review-and-audit.md).
