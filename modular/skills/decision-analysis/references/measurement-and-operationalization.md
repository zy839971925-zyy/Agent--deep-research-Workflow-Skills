...
**Related:** multimodal and data (route to the relevant sibling Skill if needed), [decision and recommendation quality](decision-and-recommendation.md), evidence and provenance (route to the relevant sibling Skill if needed).
