...
**Related:** [measurement and operationalization](measurement-and-operationalization.md), hypotheses and bias control (route to the relevant sibling Skill if needed), time, scenarios and forecasting (route to the relevant sibling Skill if needed).
