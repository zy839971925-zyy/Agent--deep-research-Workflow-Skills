...
**Related:** [reasoning structure and decomposition](reasoning-structure-and-decomposition.md), inquiry and research (route to the relevant sibling Skill if needed), [relationships and systems](relationships-and-systems.md), evidence and provenance (route to the relevant sibling Skill if needed).
