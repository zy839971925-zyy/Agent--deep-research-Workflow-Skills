...
**Related:** [problem framing and effort](problem-framing-and-effort.md), inquiry and research (route to the relevant sibling Skill if needed), [hypotheses and bias control](hypotheses-and-bias-control.md), [relationships and systems](relationships-and-systems.md).
