...
**Related:** [problem framing and effort](problem-framing-and-effort.md), inquiry and research (route to the relevant sibling Skill if needed), runtime and delegation (route to the relevant sibling Skill if needed), synthesis and verification (route to the relevant sibling Skill if needed), ultra research (route to the relevant sibling Skill if needed).
