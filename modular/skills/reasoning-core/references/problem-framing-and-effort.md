...
**Related:** [reasoning structure and decomposition](reasoning-structure-and-decomposition.md), inquiry and research (route to the relevant sibling Skill if needed), [human context and interpretation](human-context-and-interpretation.md), state model and invariants (route to the relevant sibling Skill if needed).
