...
**Related:** state model and invariants (route to the relevant sibling Skill if needed), traceability and integrity (route to the relevant sibling Skill if needed), synchronization and recovery (route to the relevant sibling Skill if needed).
